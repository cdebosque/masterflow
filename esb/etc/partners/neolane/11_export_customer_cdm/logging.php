...
$loggingParam = array(
		'rootLogger' => array( //@see http://logging.apache.org/log4php/docs/loggers.html
				'level'     => 'INFO',	//niveau à partir duquel on va prendre en compte le log. TRACE < DEBUG < INFO < WARN < ERROR < FATAL
				'appenders' => array(
		...
		'appenders' => array(	//@see http://logging.apache.org/log4php/docs/appenders.html
				...
				'mail' => array(
						...
						'params' => array(
								'from'    => 'tbondois@onlinecommercepartners.com',
								'to'      => 'tbondois@onlinecommercepartners.com',
